...
function PopulateData(){
  ...
  data.forEach((contact)=>{
    ...
    const PlayerCity = document.createElement('div');
    PlayerCity.innerText = contact.address.city;
    InnerMessage.append(PlayerCity);
    const PlayerZip = document.createElement('div');
    PlayerZip.innerText = contact.address.zipcode;
    InnerMessage.append(PlayerZip);
